...
At the operating point $\alpha=0.01$, the utility cost was within the
prespecified materiality range ($\Delta\text{AUROC}=-0.005$;
$-0.020$, $+0.010$; $p=0.39$).
...
\hline
FedAvg vs Central   & Centralized      & $\Delta$AUROC & $-0.004$ [$-0.005$, $+0.001$] & NI LCB $>-0.02$ & Non-inferior \\
